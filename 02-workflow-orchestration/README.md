...
Note:
After rendering this mask {{inputs.taxi}}_tripdata_{{inputs.year}}-{{inputs.month}}.csv and setting a taxa variable as "green",  a year as 2020 and a month as 04 it will be green_tripdata_2020-04.csv.
...
Note: SELECT COUNT(*) FROM public.yellow_tripdata
...
Note: According to Kestra documentation i.e. the second column in the Wikipedia table (https://en.wikipedia.org/wiki/List_of_tz_database_time_zones#List)